...
if (isset($_REQUEST['query']) && $_REQUEST['query'] != '' && is_numeric($_REQUEST['query']) && 
	isset($_REQUEST['action']) && !isset($_REQUEST['action2_x']) && 
	($_REQUEST['action'] == 'view' || $_REQUEST['action'] == 'loadquery')) {
