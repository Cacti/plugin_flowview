...
$stat_columns_array = array(
	5  => array(1, 2, '', '', '0', 'Port', 'Flows', 'Bytes', 'Packets'),
	6  => array(1, 2, '', '', '0', 'Port', 'Flows', 'Bytes', 'Packets'),
	7  => array(1, 2, '', '', '0', 'Port', 'Flows', 'Bytes', 'Packets'),
	8  => array(1, 2, 0,  '', '', 'Dest IP', 'Flows', 'Bytes', 'Packets'),
	9  => array(1, 2, 0,  '', '', 'Src IP', 'Flows', 'Bytes', 'Packets'),
	10 => array(1, 3, '0,1', '', '', 'Src IP', 'Dest IP', 'Flows', 'Bytes', 'Packets'),
	11 => array(1, 2, 0,  '', '', 'Src/Dest IP', 'Flows', 'Bytes', 'Packets'),
	12 => array(1, 2, '', '0', '', 'Protocol', 'Flows', 'Bytes', 'Packets'),
	17 => array(1, 2, '', '', '', 'Input IF', 'Flows', 'Bytes', 'Packets'),
	18 => array(1, 2, '', '', '', 'Output IF', 'Flows', 'Bytes', 'Packets'),
	19 => array(1, 2, '', '', '', 'Src AS', 'Flows', 'Bytes', 'Packets'),
	20 => array(1, 2, '', '', '', 'Dest AS', 'Flows', 'Bytes', 'Packets'),
	21 => array(1, 3, '', '', '', 'Src AS', 'Dest AS', 'Flows', 'Bytes', 'Packets'),
	22 => array(1, 2, '', '', '', 'TOS', 'Flows', 'Bytes', 'Packets'),
	23 => array(1, 3, '', '', '', 'Input IF', 'Output IF', 'Flows', 'Bytes', 'Packets'),
	24 => array(1, 2, '', '', '', 'Src Prefix', 'Flows', 'Bytes', 'Packets'),
	25 => array(1, 2, '', '', '', 'Dest Prefix', 'Flows', 'Bytes', 'Packets'),
	26 => array(1, 3, '', '', '', 'Src Prefix', 'Dest Prefix', 'Flows', 'Bytes', 'Packets'),
);
